document.addEventListener('DOMContentLoaded', function () {
    ...
    if (patientTable.length) {
        patientTable.DataTable({
            responsive: true,
            data: [
                ["P001", "Nuhaseereen", "35", "Male", "2025-05-10", "Dr.Joseph", ""], ["P002", "Nihal", "28", "male", "2025-05-12", "Dr. Leo das", ""],
                ["P003", "Elisa das", "45", "feMale", "2025-05-08", "Dr. Wilson", ""], ["P004", "Ananya", "62", "Female", "2025-05-11", "Dr.Saradha", ""],
                ["P005", "Arun", "19", "Male", "2025-05-09", "Dr. Davis", ""], ["P006", "Antony das", "50", "male", "2025-05-13", "Dr.Aravindh", ""],
            ],
            columns: [
    ...
    if (uploadRecordBtn) {
        uploadRecordBtn.addEventListener('click', async () => {
            const { value: file } = await Swal.fire({
                ...
                customClass: { popup: 'dark:bg-gray-800 dark:text-white', confirmButton: 'px-4 py-2 rounded-lg font-medium transition-all duration-150 focus:outline-none focus:ring-2
